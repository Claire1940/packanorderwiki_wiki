...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const siteUrl = process.env.NEXT_PUBLIC_SITE_URL || 'https://www.packanorderwiki.wiki'
  const path = '/terms-of-service'

  return {
    title: "Terms of Service - Pack an Order Wiki",
    description: "Read the Terms of Service for Pack an Order Wiki. Learn about user responsibilities, content usage guidelines, and legal terms for using our Roblox game resource platform.",
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: "Terms of Service - Pack an Order Wiki",
      description: "Terms and conditions for using Pack an Order Wiki.",
      images: [
        {
          url: `${siteUrl}/images/hero.webp`,
          width: 1200,
          height: 630,
          alt: "Pack an Order Wiki",
        },
      ],
    },
    twitter: {
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 text-lg mb-2">
            Terms and conditions for using Pack an Order Wiki
          </p>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              By accessing and using Pack an Order Wiki ("the Website", "we", "our", or "us"), you agree to be bound
              by these Terms of Service ("Terms"). If you do not agree to these Terms, please do not use our Website.
            </p>
            <p>
              These Terms constitute a legally binding agreement between you ("User", "you", or "your") and Pack an Order Wiki.
              Your continued use of the Website signifies your acceptance of these Terms and any future modifications.
            </p>

            <h2>2. Description of Service</h2>
            <p>
              Pack an Order Wiki is an unofficial, community-driven fan website that provides information, guides, tools,
              and resources related to the Roblox game "Pack an Order". Our services include, but are not limited to:
            </p>
            <ul>
              <li>Game guides and packing strategies</li>
              <li>Active codes and reward tracking</li>
              <li>Order routes and item locations</li>
              <li>Upgrade and ability breakdowns</li>
              <li>Controls and best practices</li>
              <li>Community discussion and content</li>
            </ul>
            <p>
              <strong>Important:</strong> Pack an Order Wiki is NOT affiliated with, endorsed by, or associated with
              Roblox Corporation or the official developers of Pack an Order. We are an independent fan community.
            </p>
            ...
            <p>
              ...
              graphics, logos, images, and software) are owned by Pack an Order Wiki and are protected by international
            ...
            <p>
              ...
              trademarks, are the property of Roblox Corporation and/or the developers of Pack an Order. We use such
            ...
            <ul>
              ...
              <li><strong>Game Updates:</strong> Roblox game content, features, item prices, upgrade costs, and codes may change without notice. We are not responsible for in-game changes or access issues.</li>
            </ul>
            <p>
            ...
            <p>
              TO THE FULLEST EXTENT PERMITTED BY LAW, PACK AN ORDER WIKI SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL,
            ...
            <p>
              ...
              you and Pack an Order Wiki regarding the use of the Website and supersede any prior agreements or understandings.
            </p>
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:legal@packanorderwiki.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">legal@packanorderwiki.wiki</a>
            </p>
            <p>
